...
Goals:
* Display a weaving draft in a browser -- I want this to be responsive and totally system agnostic, so I can pull it up on my tablet wherever I am, or on a 30" monitor, or any other conceiveable screen.
...
Progress: 
* The first iteration of the in-browser draft displayer is built -- it uses angularjs to build and render the draft, and will be dynamically editable as soon as I make the draft details editable. 
